# Variables universales de fish. Generado con scripts/common/fish-dump-universals.fish
# Reaplicar con: fish <este-archivo>
...
set -U _tide_left_items vi_mode os pwd git
...
set -U _tide_right_items status cmd_duration context jobs python rustc java time
